...
export class FullcourseComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.chapterlist = this._service.getChappterListByCourseName(
      this.courseName
    );
  ...
  set1() {
    ...
    $('.box2,.box3,.box4,.box5,.box6,.box7,.box8').css(
      'background-color',
      'white'
    );
    $(
      '.chapter2,.chapter3,.chapter4,.chapter5,.chapter6,.chapter7,.chapter8'
    ).removeClass('selected');
  }
  set2() {
    $('.box2').css('background-color', 'green');
    $('.chapter2').addClass('selected');
    $('.box1,.box3,.box4,.box5,.box6,.box7,.box8').css(
      'background-color',
      'white'
    );
    $(
      '.chapter1,.chapter3,.chapter4,.chapter5,.chapter6,.chapter7,.chapter8'
    ).removeClass('selected');
  }
  set3() {
    $('.box3').css('background-color', 'green');
    $('.chapter3').addClass('selected');
    $('.box1,.box2,.box4,.box5,.box6,.box7,.box8').css(
      'background-color',
      'white'
    );
    $(
      '.chapter1,.chapter2,.chapter4,.chapter5,.chapter6,.chapter7,.chapter8'
    ).removeClass('selected');
  }
  set4() {
    $('.box4').css('background-color', 'green');
    $('.chapter4').addClass('selected');
    $('.box1,.box2,.box3,.box5,.box6,.box7,.box8').css(
      'background-color',
      'white'
    );
    $(
  ...
  set5() {
    ...
    $('.box1,.box2,.box3,.box4,.box6,.box7,.box8').css(
      'background-color',
      'white'
    );
    $(
      '.chapter1,.chapter2,.chapter3,.chapter4,.chapter6,.chapter7,.chapter8'
    ).removeClass('selected');
  }
  set6() {
    $('.box6').css('background-color', 'green');
    $('.chapter6').addClass('selected');
    $('.box1,.box2,.box3,.box4,.box5,.box7,.box8').css(
      'background-color',
      'white'
    );
    $(
      '.chapter1,.chapter2,.chapter3,.chapter4,.chapter5,.chapter7,.chapter8'
    ).removeClass('selected');
  }
  set7() {
    $('.box7').css('background-color', 'green');
    $('.chapter7').addClass('selected');
    $('.box1,.box2,.box3,.box4,.box5,.box6,.box8').css(
      'background-color',
      'white'
    );
    $(
      '.chapter1,.chapter2,.chapter3,.chapter4,.chapter5,.chapter6,.chapter8'
    ).removeClass('selected');
  }
  set8() {
    $('.box8').css('background-color', 'green');
    $('.chapter8').addClass('selected');
    $('.box1,.box2,.box3,.box4,.box5,.box6,.box7').css(
      'background-color',
      'white'
    );
    $(
